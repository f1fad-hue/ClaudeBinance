...
MUT=[
 ...
 ("Brent level only", "brent=106.60,",          "brent=107.60,"),
 ("10y level+change", "ust10=5.20,   ust10_prev=5.12,  ust10_chg_bp=8",
                      "ust10=5.25,   ust10_prev=5.12,  ust10_chg_bp=13"),
...
GEN = [
 ...
 G("gap with the books reversed", "GAP = M.r2h(M.r2h(ST['baseline']['calm']['cagr_d']) - M.r2h(ST['optimized']['calm']['cagr_d']))", "GAP = M.r2h(M.r2h(ST['optimized']['calm']['cagr_d']) - M.r2h(ST['baseline']['calm']['cagr_d']))"),
 ...
 G("disclaimer dated to BMNR's price", "Market data to the {day(MK['asof'], False)} close", "Market data to the {day(M.BMNR_HOLDINGS['px_asof'], False)} close"),
 ...
 G("QQQ slide shows the basis price", "f\"${P['QQQ']['px']:.2f}\"), ('Forward P/E'", "f\"${P['QQQ']['basis_px']:.2f}\"), ('Forward P/E'"),
